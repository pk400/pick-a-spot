...
class RoomInstance(models.Model):
    ...
    listofusers = models.CharField(max_length=9999999999999999, default="[]", blank=True, null=True)
    listofpref = models.CharField(max_length=9999999999999999, default="[]", blank=True, null=True)
